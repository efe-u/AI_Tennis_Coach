...
forehand = [0.6378553657928083, 0.5942885860789922, 0.5978209734573688, 0.6014590909161445, 0.5141724781342997,
            0.5056461512805182, 0.49753747902281825, 0.37494642017578467, 0.1932101481046511, 0.546182396705269,
            0.4371119212727201, 0.599072317190434, 0.2811081232904985, 0.9834043271455667, 0.26281615495659855,
            1.4772300376946892, 0.2527139136520788, 1.570011350860978, 0.27322388584734086, 1.5098093915512925,
            0.2912532605056745, 1.4343268355317087, 0.2708994550617998, 0.24504729770730133, 0.2155527769901594,
            0.3835424053240147, 0.5697461745880179, 0.5251716092143499, 0.43958240516613467, 0.5874805594187499,
            0.40997983709940633, 0.5319772435294879, 0.5788182476748134]
forehand = np.power(np.array(forehand), 5)
test = [1] * 33


def mean_error(frames1, frames2, weight):
    # Set weights
    weights = weight
...
def modify_results(FILES, ref, frames1, frames2, weight):
    errors1, errors2 = mean_error(frames1, frames2, weight)
